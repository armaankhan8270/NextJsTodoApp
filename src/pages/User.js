...
const User = () => {
  ...
  return (
    <div className="lg:px-44  grid-cols-3 gird ">
      {Data.map((User, id) => {
        return (
          <div key={id}>
            <div class="w-fullmy-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
